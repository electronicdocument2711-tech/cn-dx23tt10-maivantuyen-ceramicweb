...
export default function AdmissionStatus({ onUpdate }: AdmissionStatusProps) {
  const [checkedMap, setCheckedMap] = useState<Record<number, boolean>>({});

  const [disc, setDisc] = useState("Răng nứu trong tình trạng ");
  const [diag, setDiag] = useState("Sâu răng");

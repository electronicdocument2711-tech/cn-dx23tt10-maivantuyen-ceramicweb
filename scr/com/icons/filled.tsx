...
export const IconCalendar: React.FC<IconSvgProps> = ({
  size,
  fill = "currentColor",
  ...props
}) => (
...
export const IconVerified: React.FC<IconSvgProps> = ({
  size,
  fill = "currentColor",
  ...props
}) => (
...
export const IconCategory: React.FC<IconSvgProps> = ({
  size,
  fill = "currentColor",
  ...props
}) => (
...
export const IconCustomer: React.FC<IconSvgProps> = ({
  size,
  fill = "currentColor",
  ...props
}) => (
...
export const IconNotification: React.FC<IconSvgProps> = ({
  size,
  fill = "currentColor",
  ...props
}) => (
...
export const IconCoinFilled: React.FC<IconSvgProps> = ({
  size,
  ...props
}) => (
  <svg
...
export const IconFlameFilled: React.FC<IconSvgProps> = ({
  size,
  ...props
}) => (
  <svg
...
export const IconMapPinFilled: React.FC<IconSvgProps> = ({
  size,
  ...props
}) => (
  <svg
...
export const IconPhoneFilled: React.FC<IconSvgProps> = ({
  size,
  ...props
}) => (
  <svg
